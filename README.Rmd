...
codes between ICD10 and ICD9 standards. This is not entirely non-trivial, given that there
are way more codes in ICD10, entailing more detailed diagnoses. Therefore, the conversion
...
on a MacBook Pro (2010), running MacOSX 10.12, R 3.3.1, with 16 GB RAM:

![](figure.png?raw=true)

This is a very early version of the package, which should undergo substantial additional testing.
